...
<ui:fieldGroup>
        ...
        <table class="fieldAndAccessories">
            ...
            <tr>
                <c:if test="${ad:isInternal()}">
                    ...
                    <tiles:insertTemplate template="column.jsp">
                        <tiles:putAttribute name="column" value="averageActualCPC"/>
                    </tiles:insertTemplate>
                </c:if>
    ...
    <ui:field labelKey="report.input.field.settingsColumns">
        <table class="fieldAndAccessories">
            <tr>
                <tiles:insertTemplate template="column.jsp">
                    <tiles:putAttribute name="column" value="currentCPCBid"/>
                </tiles:insertTemplate>
                ...
                <td class="withField" colspan="4"></td>
            </tr>
            <tr>
                ...
                <tiles:insertTemplate template="column.jsp">
                    <tiles:putAttribute name="column" value="textAdGroup"/>
                </tiles:insertTemplate>

                <tiles:insertTemplate template="column.jsp">
                    <tiles:putAttribute name="column" value="textAd"/>
                </tiles:insertTemplate>

                <tiles:insertTemplate template="column.jsp">
                    <tiles:putAttribute name="column" value="keywordType"/>
                </tiles:insertTemplate>
        ...
        <table style="display: none;">
            <tr>
                <tiles:insertTemplate template="column.jsp">
                    <tiles:putAttribute name="column" value="keyword"/>
                </tiles:insertTemplate>
            </tr>
        </table>
    </ui:field>

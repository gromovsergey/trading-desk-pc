...
<s:form action="admin/Notices/save">
    <s:hidden name="type"/>
    ...
    <ui:section>
        <ui:fieldGroup>
            <ui:field labelKey="Notice.value" labelForId="noticeContent">
                <s:textarea name="value" id="noticeContent" cssClass="middleLengthText"/>
            </ui:field>
        </ui:fieldGroup>
    </ui:section>

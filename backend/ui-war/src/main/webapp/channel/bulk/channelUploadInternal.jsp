...
<ui:section titleKey="channel.upload.title">
    ...
    <s:form action="uploadInternal/validate" method="POST" enctype="multipart/form-data" id="channelUpload">
        <ui:fieldGroup>
            ...
            <ui:field cssClass="withButton">
                ...
                <s:if test="not validationResult">
                    <ui:button message="form.cancel" href="${_context}/channel/main.action" onclick="" type="button" />
                </s:if>
            </ui:field>
        </ui:fieldGroup>
    </s:form>
...
<s:if test="validationResult">
    ...
    <s:form action="uploadInternal/submit" method="POST" id="channelSubmit">
            ...
            <ui:fieldGroup>
                ...
                <ui:field cssClass="withButton">
                    ...
                    <s:if test="not alreadySubmitted">
                        <ui:button message="form.cancel" href="${_context}/channel/main.action" type="button" />
                    </s:if>
                </ui:field>
            </ui:fieldGroup>
        </ui:section>

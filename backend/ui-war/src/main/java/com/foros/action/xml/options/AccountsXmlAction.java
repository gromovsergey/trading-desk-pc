...
public class AccountsXmlAction extends AbstractOptionsAction<AccountTO> {
    @EJB
    ...
    protected Collection<? extends AccountTO> getOptions() throws ProcessException {
        return accountService.search(false, getInternalAccountId(), countryCodes, getAccountRoles());
    }

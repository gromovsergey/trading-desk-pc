...
public class CancellableSelectionFailuresTrendReportAction extends CancellablePageReportingAction  implements BreadcrumbsSupport, RequestContextsAware {
    ...
    public Breadcrumbs getBreadcrumbs() {
        ...
        return new Breadcrumbs().add(new CampaignBreadcrumbsElement(group.getCampaign())).add(new CampaignGroupBreadcrumbsElement(group)).add("reports.selectionFailuresTrendReport");
    }

...
public class AdvertisersTreeFilterAction extends AdvertiserReportAbstractTreeFilterAction {
    ...
    protected List<TreeFilterElementTO> generateOptions() {
        return accountService.searchAdvertisersWithCampaigns(ownerId, display);
    }

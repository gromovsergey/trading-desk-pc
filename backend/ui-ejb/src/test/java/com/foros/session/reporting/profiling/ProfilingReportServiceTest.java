...
public class ProfilingReportServiceTest extends AbstractServiceBeanIntegrationTest {
    @Autowired
    private IspAccountTestFactory testFactory;

    @Autowired
    private ProfilingReportService reportService;

    @Test
    public void testProcessHtml() {
        ProfilingReportParameters parameters = new ProfilingReportParameters();

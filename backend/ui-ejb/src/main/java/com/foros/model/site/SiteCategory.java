...
@Entity
@Table(name = "SITECATEGORY")
public class SiteCategory extends VersionEntityBase implements Serializable, Identifiable, IdNameEntity {
    @SequenceGenerator(name = "SiteCategoryGen", sequenceName = "SITECATEGORY_SITE_CATEGORY_ID_SEQ", allocationSize = 1)
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SiteCategoryGen")
    ...
    public String toString() {
        return "com.foros.model.site.SiteCategory[id=" + getId() + "]";
    }

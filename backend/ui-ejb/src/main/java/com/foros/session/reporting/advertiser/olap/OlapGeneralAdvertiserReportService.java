...
@LocalBean
@Stateless(name = "OlapGeneralAdvertiserReportService")
@Interceptors({RestrictionInterceptor.class, ValidationInterceptor.class})
public class OlapGeneralAdvertiserReportService extends OlapAdvertiserReportServiceBase {
        ...
        protected OlapAdvertiserReportDescription getDescription(OlapAdvertiserReportParameters params) {
            return params.getReportType().getGeneralDescription();
        }
        ...
        @Override
        @Restrict(restriction = "Report.GeneralAdvertiser.run", parameters = "#parameters")
        @Validate(validation = "Reporting.generalAdvertiser", parameters = "#parameters")
    ...
    private class Report extends OlapAdvertiserReportServiceBase.Report {
        ...
        public ReportType getReportType() {
            return ReportType.GENERAL_ADVERTISING;
        }

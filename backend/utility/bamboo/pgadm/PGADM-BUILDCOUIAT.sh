...
postgresdb_download_colocation_xml "moscow-nb-oui-at" "$VERSION"
postgresdb_create_config_rpms "$VERSION" "trunk" "$COLO_XML_FILE"

create_store "moscow-nb-at-postgresdb"
put_to_store "moscow-nb-at-postgresdb" $WORKING_DIR/postgresdb_rpms

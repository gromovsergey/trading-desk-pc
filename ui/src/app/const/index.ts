...
export const APP_POSTFIX = 'Target RTB';
export const APP_POSTFIX_GENIUS = 'Genius Group';
export const APP_POSTFIX_PHARMATIC = 'Pharmatic';
export const LANG_DEFAULT = 'ru';
export const LS_LANG = 'lang';
export const LS_EMAIL = 'email';
export const LS_USER = 'user';
export const SESSION_LAST_URL = 'lu';
export const SESSION_AGENCY = 'agency';
...
export const API = {
  ...
  flight: {
    ...
    applyToStrategies: '/rest/flight/setPartAll'
  },
  geo: {
...
export const SEARCH_DEFAULT_VALUE = 'ALL';

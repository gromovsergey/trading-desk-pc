...
@Component({
  ...
  templateUrl: 'flight-edit-geotarget.component.html',
  styleUrls: ['./flight-edit-geotarget.component.scss']
})
export class FlightEditGeotargetComponent implements OnInit, OnDestroy {

  public _ids_geoChannelIds: number[];
  public _id_excludedGeoChannelIds: number[];
  ...
  init(){
    ...
    this.geoSearch$.pipe(
      ...
      this.autocomplete = res.filter(local => !this._ids_geoChannelIds.includes(local.id));
